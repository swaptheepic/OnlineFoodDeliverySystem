...
public class restest_6 {
	public static void main(String[] args) throws Exception {
		System.setProperty("webdriver.firefox.marionette", "C:\\geckodriver.exe");
		WebDriver driver = new FirefoxDriver();
		driver.get("http://http://localhost:8080/OnlineFoodDeliverySystem/res_6.jsp");
		...
		if (url.equals("http://localhost:8080/OnlineFoodDeliverySystem/res_6.jsp?uname=rest6&pwd=rest6")) {
