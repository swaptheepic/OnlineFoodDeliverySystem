...
public class restest_3 {
	public static void main(String[] args) throws Exception {
		System.setProperty("webdriver.firefox.marionette", "C:\\geckodriver.exe");
		WebDriver driver = new FirefoxDriver();
		driver.get("http://http://localhost:8080/OnlineFoodDeliverySystem/res_3.jsp");
		...
		if (url.equals("http://localhost:8080/OnlineFoodDeliverySystem/res_3.jsp?uname=rest3&pwd=rest3")) {
