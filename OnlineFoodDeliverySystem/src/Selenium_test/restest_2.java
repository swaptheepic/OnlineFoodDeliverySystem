...
public class restest_2 {
	public static void main(String[] args) throws Exception {
		System.setProperty("webdriver.firefox.marionette", "C:\\geckodriver.exe");
		WebDriver driver = new FirefoxDriver();
		driver.get("http://http://localhost:8080/OnlineFoodDeliverySystem/res_2.jsp");
		...
		if (url.equals("http://localhost:8080/OnlineFoodDeliverySystem/res_2.jsp?uname=rest2&pwd=rest2")) {
