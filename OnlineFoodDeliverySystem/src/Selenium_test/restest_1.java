...
public class restest_1 {
	public static void main(String[] args) throws Exception {
		System.setProperty("webdriver.firefox.marionette", "C:\\geckodriver.exe");
		WebDriver driver = new FirefoxDriver();
		driver.get("http://http://localhost:8080/OnlineFoodDeliverySystem/res_1.jsp");
		...
		if (url.equals("http://localhost:8080/OnlineFoodDeliverySystem/res_1.jsp?uname=rest1&pwd=rest1")) {
