                    ...
                    <div align="center">
						...
						<form action="alog" method="post">
							...
							<table border="0" cellpadding="5" cellspacing="8">
								<tr>
									<td>Username</td>
									<td><input type="text" name="uname" style="height: 25px"; id="uname" required/></td>

								</tr>
																<tr>
									<td>Password</td>
									<td><input type="password" name="pwd" style="height: 25px"; id="pwd" required/></td>

								</tr>
								<tr/>
								<tr>
								<td></td>
									<td><input type="submit" style="height: 35px; width: 90px;" value="Login"></td>
