						...
						<br />
						 <form action="lreg" name="ureg" method="post">
							...
							<table border="0" cellpadding="5" cellspacing="8">
								<tr>
									<td>Customer Name</td>
									<td><input type="text" name="fname" pattern="[a-zA-Z]{1,}" id="fname"
										placeholder=" Name" style="height: 28px"
								...
								<tr>
									<td>Mobile Number</td>
									<td><input type="text" name="mbnumber" pattern="\d{10}" maxlength="10" id="mbnumber"
								...
								<tr>
									...
									<td><input type="password" name="pwd" pattern=".{6,}"  id="pwd"
