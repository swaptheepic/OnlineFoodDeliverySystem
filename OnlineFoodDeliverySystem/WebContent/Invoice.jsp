...
<body>
	...
	<div id="main-content">
		...
		<div class="tabcontent">
			...
			<table align="center" cellpadding="5" border="1" cellspacing="5"
				...
				<%
					Connection con = DB_Connection.get_connection();
						...
						String order_id;
						String m_item = null, price = null, qty = null, tot = null,rest_id = null,user_id=null;
						int res1_orders = 0;
						int res2_orders = 0;
						int res3_orders = 0;
						int res4_orders = 0;
				...
				<%
				PreparedStatement address = con.prepareStatement("select * from user where username="+ user_id +"and order_id="+s.getId().toString());
							ResultSet add = address.executeQuery();
							while (add.next()) {
							String my_add = add.getString("address");
							
							System.out.println(m_item + " "/*+price*/);%>
				<text align="left"> <p2>Address <%=my_add %></p2></text>
			<br>
				<%
							}
						}				
			...
			<text align="left"> <p2>Order ID <%=s.getId().toString() %></p2></text>
			<br>
